sap.ui
	.define(
		["sap/ui/core/UIComponent", "sap/ui/Device",
			"com/sap/cloud/workflow/samples/onboardapprove/model/models"
		],
		function (UIComponent, Device, models) {
			...
			return UIComponent
				.extend(
					"com.sap.cloud.workflow.samples.onboardapprove.Component", {
						...
						init: function () {
							...
							var contextModel = new sap.ui.model.json.JSONModel(
								"/comsapcloudworkflowsamplesonboardapprove/bpmworkflowruntime/v1/task-instances/" + taskId + "/context");
						...
						// This method is called when the end
						// user chooses to accept or reject the
						// equipment proposed
						_triggerComplete: function (taskId,
							...
							$
								.ajax({
									...
									// get the xsrf token
									url: "/comsapcloudworkflowsamplesonboardapprove/bpmworkflowruntime/v1/xsrf-token",
									method: "GET",
									headers: {
										"X-CSRF-Token": "Fetch"
									},
									success: function (
										...
										$
											.ajax({
												url: "/comsapcloudworkflowsamplesonboardapprove/bpmworkflowruntime/v1/task-instances/" + taskId,
												method: "PATCH",
