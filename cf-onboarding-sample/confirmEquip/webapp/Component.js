sap.ui
	.define(
		["sap/ui/core/UIComponent", "sap/ui/Device",
			"com/sap/cloud/workflow/samples/onboardequip/model/models"
		],
		function (UIComponent, Device, models) {
			...
			return UIComponent
				.extend(
					"com.sap.cloud.workflow.samples.onboardequip.Component", {
						...
						init: function () {
							...
							var contextModel = new sap.ui.model.json.JSONModel(
								"/comsapcloudworkflowsamplesonboardequip/bpmworkflowruntime/v1/task-instances/" + taskId + "/context");
							var contextData = contextModel
								.getData();

							// Load product list from a locally
							// available json model
							// You can replace the static
							// products and call the service to
							// retrive
							// product list from your
							// procurement system
							var prodModel = new sap.ui.model.json.JSONModel();
							prodModel
								.loadData(
									"/comsapcloudworkflowsamplesonboardequip/model/products.json",
									null, false);
							var initModel = new sap.ui.model.json.JSONModel();
							initModel
								.loadData(
									"/comsapcloudworkflowsamplesonboardequip/model/init.json",
									null, false);
							...
							contextModel
								.attachRequestCompleted(function () {
									...
									// Set product list to
									// the model
									contextData.newEquipment = initModel
										.getData();
									contextData.products = prodModel
										.getData();
							...
							var oPositiveAction = {
								...
								onBtnPressed: function () {
									...
									// a JSON string
									var equip = JSON
										.stringify(processContext.equipment);
						...
						// user
						_triggerComplete: function (equip,
							...
							$
								.ajax({
									...
									// get the xsrf token
									url: "/comsapcloudworkflowsamplesonboardequip/bpmworkflowruntime/v1/xsrf-token",
									method: "GET",
									headers: {
										"X-CSRF-Token": "Fetch"
									},
									success: function (
										...
										$
											.ajax({
												...
												// the
												// task
												url: "/comsapcloudworkflowsamplesonboardequip/bpmworkflowruntime/v1/task-instances/" + taskId,
												method: "PATCH",
