sap.ui.define(["sap/m/MessageToast",
	...
	return Controller.extend("com.sap.cloud.workflow.samples.onboardequip.controller.ConfirmEquipment", {

		onAddEquipment: function (oEvent) {
			if (!this.oDialog) {
				this.oDialog = sap.ui.xmlfragment("com.sap.cloud.workflow.samples.onboardequip.view.NewEquipment", this);
